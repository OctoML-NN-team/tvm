...
@conv2d_alter_layout.register(["IrisXe"])
...
@conv2d_infer_layout.register("IrisXe")
def _conv2d_infer_layout(workload, cfg):
    ...
    tile_ic, tile_oc = cfg["tile_ic"], cfg["tile_oc"]
