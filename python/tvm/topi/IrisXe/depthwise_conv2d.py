...
@autotvm.register_topi_compute("depthwise_conv2d_nchw.IrisXe")
...
@autotvm.register_topi_schedule("depthwise_conv2d_nchw.IrisXe")
        ...
        if op.tag == "depthwise_conv2d_nchw":
            ...
            if cfg.is_fallback:
                ref_log = autotvm.tophub.load_reference_log(
                    target.kind.name, target.model, "depthwise_conv2d_nchw.IrisXe"
                )
...
@depthwise_conv2d_infer_layout.register("IrisXe")
